...
public class community_to_gallery extends BaseAdapter {
    private String imgData;
    private String geoData;
    private ArrayList<String> thumbsDataList;
    private ArrayList<String> thumbsIDList;
    private Context mContext;
    community_to_gallery(Context c){
        mContext = c;
...
//        imageView.setImageBitmap(resized);
    ...
    public final String callImageViewer(int selectedIndex){
//        Intent i = new Intent(mContext,community_imagepopup.class);
